...
# 1000  level of districts   около 20 Гб данных примерно 3 часа подсчета
# 250   level of city blocks Невозможно в лабораторной среде 3.5 ТБ данных, 10 дней подсчета
# 50    level of buildings   Невозможно в лабораторной среде 90 Тб данных, 273 дня подсчета
